      ...
      {data.type[0] !== "Paper" && (
        <nav className="mt-6 text-gray-500 dark:text-gray-400">
          ...
          <div className="flex items-center mb-4">
            {data.tags && (
              <div className="flex flex-nowrap max-w-full overflow-x-auto gap-2">
          ...
          {data.thumbnail && (
            <div className="relative w-full pb-[66%] lg:pb-[50%] bg-gray-200 dark:bg-gray-800 mb-7 rounded-xl overflow-hidden">
              <Image
                src={data.thumbnail}
