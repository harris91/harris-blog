  ...
  return (
    <div className={className}>
      <Menu as="div" className="w-full inline-block text-left">
        ...
        >
          <Menu.Items className="absolute overflow-auto h-auto max-h-96 z-10 right-0 mt-2 w-full rounded-lg border border-black dark:border-white border-opacity-20 dark:border-opacity-20 bg-opacity-80 backdrop-blur-md focus-visible:ring
          ">
              ...
              {({ active }) => (
                <button
                  className={`
                    ...
                    ${ active ? 'bg-white bg-gray-400 bg-opacity-20 dark:text-white' : 'dark:text-white'} 
