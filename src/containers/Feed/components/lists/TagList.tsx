    ...
    <div className={className}>
      ...
      <ul className="cursor-pointer gap-1 flex mobile-x-scroll lg:block mb-6">
        {Object.keys(data).map((key) => (
          <li
            key={key}
            className={`text-sm p-1 px-4 my-1 flex-shrink-0 rounded-xl text-gray-500 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-800 ${
              key === currentTag &&
              'text-black bg-white dark:bg-gray-800 hover:bg-white dark:hover:bg-gray-800'
            }`}
