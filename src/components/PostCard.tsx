  ...
  return (
    <Link href={`/${post.slug}`}>
      <a>
        <article
          key={post.id}
          className="overflow-hidden mb-6 md:mb-8 rounded-2xl bg-white dark:bg-zinc-800 hover:shadow-lg transition-shadow "
        >
          {post.thumbnail && (
            <div className="relative w-full pb-[66%] lg:pb-[50%] bg-gray-200 dark:bg-zinc-800 ">
              <Image
                src={post.thumbnail}
